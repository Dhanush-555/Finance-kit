...
export const LoanTracker: React.FC = () => {
  ...
  const handleEditClick = (loan: Loan) => {
    ...
    setFormData({
      ...
      tenure: String(loan.tenureType === 'monthly' ? loan.tenureMonths : (loan.tenureType === 'daily' ? loan.tenureMonths / 30 : loan.tenureMonths / 4.3333)),
      interestType: loan.interestType,
      interestRatePeriod: loan.interestRatePeriod || 'monthly',
      repaymentFrequency: loan.tenureType,
      penalty: String(loan.penaltyRate || 50),
      date: loan.loanDate,
